...
import com.google.lecture_manager.client.utils.factories.UIFactory;
...
public class LectureManager implements EntryPoint {
  ...
  public void onModuleLoad() {
    ...
    mainContainer.setCenterWidget(UIFactory.getWidget(ElementTypes.LOGIN_FORM));
  ...
  private void initHandlers() {
    AppUtils.EVENT_BUS.addHandler(SignUpEvent.TYPE, new SignUpEventHandler() {
      public void onSignUpEvent(SignUpEvent signUpEvent) {
        mainContainer.setCenterWidget(UIFactory.getWidget(ElementTypes.SIGN_UP_FORM));
